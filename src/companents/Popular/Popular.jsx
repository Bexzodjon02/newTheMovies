...
export default function Popular() {
    ...
    useEffect(() => {
      ...
      async function getDate() {
        let result = await fetch(`https://api.themoviedb.org/3/movie/popular?api_key=${API_KEY}&language=en-US&page=4`)
          .then(ress => {
            return ress.json()
          })
          .catch(err => {
                ...
                return (
                    <div key={index} className="col-3">
                        ...
                        <SaveBtn massiv={item}/>
                            ...
                            <h4 style={{ fontSize: "15px", fontWeight: '800' }} className="mt-4">{item.title}</h4>
